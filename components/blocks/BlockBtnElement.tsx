...
const BlockBtnElement = ({
  ...
  return (
    <Button
      ...
      disabled={disabled}
      className={cn(
        `flex flex-col gap-2 size-20 cursor-grab !bg-white border-2 border-primary/30 hover:border-none text-gray-600 hover:ring-1 hover:!ring-primary`,
        draggable.isDragging && "ring-2 ring-primary shadow-lg",
